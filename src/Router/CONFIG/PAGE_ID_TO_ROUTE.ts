...
export const PAGE_ID_TO_ROUTE = Object.freeze({
    ...
    [PAGE_ID.REPOSITORY.ISSUES]: '/repository/:username/:repository/issues',
    [PAGE_ID.REPOSITORY.ISSUE]: '/repository/:username/:repository/issue/:id',
    [PAGE_ID.REPOSITORY.PULL_REQUESTS]: '/repository/:username/:repository/pulls',
    [PAGE_ID.REPOSITORY.PULL_REQUEST]: '/repository/:username/:repository/pull/:id',
