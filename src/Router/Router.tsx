                ...
                <Root>
                    <Switch>
                        <Route path={PAGE_ID_TO_ROUTE[PAGE_ID.NOT_FOUND]}
                               ...
                               exact={true} />
                        <Route path={PAGE_ID_TO_ROUTE[PAGE_ID.REPOSITORY_REDIRECT]}
                               component={PAGE_ID_TO_COMPONENT[PAGE_ID.REPOSITORY_REDIRECT]}
                               exact={true} />
                        <Route path={PAGE_ID_TO_ROUTE[PAGE_ID.INDEX]}
                               component={PAGE_ID_TO_COMPONENT[PAGE_ID.INDEX]}
                               exact={true} />
                        <Route path={PAGE_ID_TO_ROUTE[PAGE_ID.SEARCH]}
                               component={PAGE_ID_TO_COMPONENT[PAGE_ID.SEARCH]}
                               exact={true} />
